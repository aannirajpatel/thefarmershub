...
$sql = "INSERT INTO comment(ctext,uid,articleid) VALUES('$comment',$uid,$articleid)";
...
?>
  ...
  <div class="card-body">
    ...
    <?php
if ($result) {
    echo 'Your comment has been added. Click <a href="../articles/viewarticle.php?articleid='.$articleid.'">here</a> to view your comment on the article page.';
}
else {
    echo "We were unable to post your comment. Please try again later.";
}
mysqli_close($con);
?>
