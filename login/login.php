  ...
  <body class="bg">
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="../login/login.php">Login
            </a>
          </li>
          <li class="nav-item">
    ...
    <div class="container" style="color: white">
      <h3>Welcome! Join the Indian Community of Farmers.
      </h3>
      </a>
    </p>
  <hr>
  ...
  <aside class="col-sm-4">
    <div class="card">
      <article class="card-body">
        <a href="../signup/signup.php" class="float-right btn btn-outline-primary">Sign up
        </a>
        <h4 class="card-title mb-4 mt-1">Login
        </h4>
